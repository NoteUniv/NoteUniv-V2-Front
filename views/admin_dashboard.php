        ...
        <div class="flex">
            <div class="mb-4 w-2/3 mr-6">
                <div class="flex justify-between items-center mb-8">
                    ...
                    <div>
                        <input type="search" id="mecc-search" placeholder="Search..." class="bg-nu-gray-100 text-nu-secondary px-4 py-2 mr-4">
                        <select name="semesters" id="semester-select" class="bg-nu-gray-100 text-nu-secondary px-4 py-2">
