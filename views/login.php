<div class="flex h-screen w-full">
    <div class='w-1/2 flex text-nuPrimary'>
        <div class="m-auto flex flex-col items-center gap-y-10">
            ...
            <form action="#" class="flex flex-col gap-y-6 bg-white shadow-drop px-6 py-10 text-sm min-w-[400px]">
                <div>
                    ...
                    <div class="flex h-10">
                        <div class="absolute w-10 h-10 bg-nuPrimary flex-shrink-0 flex">
                        ...
                        <input type="email" id="email" name="email" placeholder="Your unistra email"
                            ...
                            class="input py-2 pl-14 pr-4 outline-2 outline-nuPrimary/70 focus:outline placeholder:text-nuGray-300">
                    </div>
                </div>
                <div>
                ...
                <div class="ml-auto w-fit">
                    <a href="#" class="text-nuSecondary underline mr-8">Forgot password</a>
    ...
    <div class="w-1/2 h-full bg-nuPrimary"></div>
</div>