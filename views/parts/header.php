<div class="grid grid-cols-10">
  <div class="w-full col-start-2 col-span-8 pb-10 pt-16 flex justify-between">
    ...
    <div class="relative" x-data="{ isOpen: false}">
      <div class="flex items-center cursor-pointer" @keydown.escape="isOpen = false">
        <img src="./src/assets/images/account-icon.svg" alt="" class="mr-4">
        <p class="text-xl font-semibold mr-4">email@etu.unistra.fr</p>
        <div class="bg-white py-4 px-3 rounded-xl shadow-drop" @mouseEnter="isOpen = true" @mouseLeave="isOpen = false">
          <img src="./src/assets/images/chevron-down.svg" alt="">
          <ul x-show="isOpen"
          class="absolute font-normal bg-white shadow overflow-hidden rounded w-48 border py-1 right-0 z-20 top-full">
            <li>
