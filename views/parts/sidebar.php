<aside class="sticky flex flex-col top-0 col-span-2 bg-white h-screen overflow-y-hidden shadow-drop">
    <a href="#" class="bg-nuPrimary w-full aspect-square flex items-center justify-center">
        <img class="w-2/3" src="./src/assets/images/logo.svg" alt="">
    </a>
    <select name="semesters" id="semester-select" class="bg-nuSecondary w-full text-white px-6 py-2">
    ...
    <div class="bg-nuGray-100 w-full py-4 text-center">
        <p class="mb-2">Moyenne générale</p>
        <div>
            <span class="text-nuGreen text-2xl">14,95</span>
            <span class="text-nuGray-300">/ 20</span>
        </div>
    </div>
    <nav class="flex-grow py-10 px-6 text-lg font-medium">
        <ul class="flex flex-col gap-y-8">
            <li>
                <a href="" class="flex items-center hover:text-nuSecondary">
